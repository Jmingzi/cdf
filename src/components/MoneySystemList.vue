        ...
        <el-table-column
          ...
          <template slot-scope="scope">
            ...
            <template v-if="isFromMe">
              <a href="javascript:" v-if="scope.row.expenseStatus === 1" class="color-error" @click="doOption(3, scope.row)">撤回</a>
            </template>
            <template v-if="isToMe">
              <template v-if="scope.row.expenseStatus === 1">
              ...
              <template v-else-if="scope.row.expenseStatus === 5">
    ...
    <el-dialog
      ...
      <template v-if="currentChooseItem">
        ...
        <span slot="footer" class="dialog-footer">
          <template v-if="isFromMe">
              <a href="javascript:" v-if="currentChooseItem.expenseStatus === 1" class="color-error" @click="doOption(3)">撤回</a>
            </template>
          <template v-if="isToMe">
            <template v-if="currentChooseItem.expenseStatus === 1">
            ...
            <el-button v-else-if="currentChooseItem.expenseStatus === 5" type="primary" @click="doOption(4)" size="small">打 款</el-button>
          </template>
        </span>
      </template>
    </el-dialog>
